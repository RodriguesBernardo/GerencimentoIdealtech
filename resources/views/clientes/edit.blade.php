                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="cpf_cnpj" name="cpf_cnpj" value="{{ old('cpf_cnpj', $cliente->cpf_cnpj) }}" placeholder="00.000.000/0000-00">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="celular" name="celular" value="{{ old('celular', $cliente->celular) }}" placeholder="(00) 00000-0000">
                        @error('celular')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="cep" name="cep" value="{{ old('cep', $cliente->cep) }}" placeholder="00000-000">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="uf" name="uf" value="{{ old('uf', $cliente->uf) }}" maxlength="2">
                                @error('uf')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Verificar se já tem CNPJ preenchido e mostrar botão de busca
    ...
    btnBuscarCnpj.addEventListener('click', async function() {
        ...
        loadingMessage.textContent = 'Buscando dados da empresa...';
        loadingModal.show();
        ...
        try {
            ...
            loadingModal.hide();
            successTitle.textContent = 'Dados da empresa carregados!';
            successMessage.textContent = 'Os dados da empresa foram carregados com sucesso.';
            successModal.show();
    ...
    async function buscarCep() {
        ...
        loadingMessage.textContent = 'Buscando endereço...';
        loadingModal.show();
        ...
        try {
            ...
            successMessage.textContent = 'O endereço foi carregado automaticamente.';
            successModal.show();
